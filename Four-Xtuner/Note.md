...
[
    {
        "conversation": [
            {
                "input": "请介绍一下你自己",
                "output": "我是吃百香果不吃籽的小助手，内在是上海AI实验室书生·浦语的7B大模型哦"
            }
        ]
    },
    {
...
(这是一份修改好的文件[internlm_chat_7b_qlora_oasst1_e3_copy.py]
...
## 3.效果
微调前
![web_show_1.png](./figure/fig01.png)

微调后
![web_show_2.png](./figure/fig02.png)